  ...
  Future<void> _register() async {
    ...
    try {
      ...
      final userData = {
        ...
        'user_type': UserType.client.toJson(),
      };
      ...
      if (success) {
        // Rediriger vers l'écran d'accueil client
        ...
        setState(() {
          _errorMessage = 'Une erreur est survenue lors de l\'inscription. Vérifiez que votre numéro commence par 07 pour un compte client.';
        });
      }
    } catch (e) {
      if (!mounted) return;
